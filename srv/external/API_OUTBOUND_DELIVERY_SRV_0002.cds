/* checksum : bbaae0537e258c7a6f3a33f47a1d1ec3 */
@cds.external : true
@m.IsDefaultEntityContainer : 'true'
@sap.supported.formats : 'atom json xlsx'
service API_OUTBOUND_DELIVERY_SRV_0002 {};
...
entity API_OUTBOUND_DELIVERY_SRV_0002.A_OutbDeliveryItemText {
  @sap.unicode : 'false'
  @sap.label : 'Delivery'
  @sap.updatable : 'false'
  @sap.sortable : 'false'
...
entity API_OUTBOUND_DELIVERY_SRV_0002.A_OutbDeliveryHeaderText {
  @sap.unicode : 'false'
  @sap.label : 'Delivery'
  @sap.updatable : 'false'
  @sap.sortable : 'false'
...
entity API_OUTBOUND_DELIVERY_SRV_0002.A_HandlingUnitHeaderDelivery {
  @sap.unicode : 'false'
  ...
  to_HandlingUnitItemDelivery : Association to many API_OUTBOUND_DELIVERY_SRV_0002.A_HandlingUnitItemDelivery on to_HandlingUnitItemDelivery.HandlingUnitInternalId = HandlingUnitInternalId;
};
...
entity API_OUTBOUND_DELIVERY_SRV_0002.A_HandlingUnitItemDelivery {
  @sap.unicode : 'false'
  @sap.label : 'Internal HU no.'
  @sap.sortable : 'false'
  @sap.filterable : 'false'
...
entity API_OUTBOUND_DELIVERY_SRV_0002.A_OutbDeliveryAddress2 {
  @sap.unicode : 'false'
...
entity API_OUTBOUND_DELIVERY_SRV_0002.A_OutbDeliveryItem {
  @sap.unicode : 'false'
  @sap.label : 'Delivery'
  @sap.updatable : 'false'
  key DeliveryDocument : String(10) not null;
  ...
  @cds.ambiguous : 'missing on condition?'
  to_SerialDeliveryItem : Association to API_OUTBOUND_DELIVERY_SRV_0002.A_SerialNmbrDelivery on to_SerialDeliveryItem.DeliveryDocument = DeliveryDocument and to_SerialDeliveryItem.DeliveryDocumentItem = DeliveryDocumentItem;
  @cds.ambiguous : 'missing on condition?'
  to_DocumentFlow : Association to many API_OUTBOUND_DELIVERY_SRV_0002.A_OutbDeliveryDocFlow on to_DocumentFlow.PrecedingDocument = DeliveryDocument and to_DocumentFlow.PrecedingDocumentItem = DeliveryDocumentItem;
  @cds.ambiguous : 'missing on condition?'
  to_HandlingUnitItemDelivery : Association to many API_OUTBOUND_DELIVERY_SRV_0002.A_HandlingUnitItemDelivery on to_HandlingUnitItemDelivery.DeliveryDocument = DeliveryDocument and to_HandlingUnitItemDelivery.DeliveryDocumentItem = DeliveryDocumentItem;
  @cds.ambiguous : 'missing on condition?'
  to_DeliveryDocumentItemText : Association to many API_OUTBOUND_DELIVERY_SRV_0002.A_OutbDeliveryItemText on to_DeliveryDocumentItemText.DeliveryDocumentItem = DeliveryDocumentItem and to_DeliveryDocumentItemText.DeliveryDocument = DeliveryDocument;
} actions {
  action CreateBatchSplitItem(
    ...
    @sap.label : 'Sales Unit'
    DeliveryQuantityUnit : String(3)
  ) returns API_OUTBOUND_DELIVERY_SRV_0002.CreatedDeliveryItem;
};
...
entity API_OUTBOUND_DELIVERY_SRV_0002.A_OutbDeliveryHeader {
  @sap.unicode : 'false'
  @sap.label : 'Delivery'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  ...
  @cds.ambiguous : 'missing on condition?'
  to_DeliveryDocumentText : Association to many API_OUTBOUND_DELIVERY_SRV_0002.A_OutbDeliveryHeaderText on to_DeliveryDocumentText.DeliveryDocument = DeliveryDocument;
  @cds.ambiguous : 'missing on condition?'
  to_HandlingUnitHeaderDelivery : Association to many API_OUTBOUND_DELIVERY_SRV_0002.A_HandlingUnitHeaderDelivery on to_HandlingUnitHeaderDelivery.DeliveryDocument = DeliveryDocument;
  @cds.ambiguous : 'missing on condition?'
  to_DeliveryDocumentPartner : Association to many API_OUTBOUND_DELIVERY_SRV_0002.A_OutbDeliveryPartner on to_DeliveryDocumentPartner.SDDocument = DeliveryDocument;
  @cds.ambiguous : 'missing on condition?'
  to_DeliveryDocumentItem : Composition of many API_OUTBOUND_DELIVERY_SRV_0002.A_OutbDeliveryItem on to_DeliveryDocumentItem.DeliveryDocument = DeliveryDocument;
} actions {
  action DeleteAllHandlingUnitsFromDelivery() returns API_OUTBOUND_DELIVERY_SRV_0002.HuReturn;
  ...
  ) returns many API_OUTBOUND_DELIVERY_SRV_0002.PickingReport;
  action AssignHandlingUnitToDelivery(
    @sap.label : 'Handling Unit'
    HandlingUnitExternalId : String(20)
  ) returns API_OUTBOUND_DELIVERY_SRV_0002.HuReturn;
  ...
  action PostGoodsIssue() returns many API_OUTBOUND_DELIVERY_SRV_0002.PickingReport;
  action ReverseGoodsIssue(
    @odata.Type : 'Edm.DateTime'
    @sap.label : 'Actual GI Date'
    ActualGoodsMovementDate : DateTime
  ) returns many API_OUTBOUND_DELIVERY_SRV_0002.Return;
  action ConfirmPickingAllItems() returns many API_OUTBOUND_DELIVERY_SRV_0002.PickingReport;
  action ConfirmPickingOneItem(
    @sap.label : 'Item'
    DeliveryDocumentItem : String(6)
  ) returns many API_OUTBOUND_DELIVERY_SRV_0002.PickingReport;
  action PickAllItems() returns many API_OUTBOUND_DELIVERY_SRV_0002.PickingReport;
  action PickOneItem(
    @sap.label : 'Item'
    DeliveryDocumentItem : String(6)
  ) returns many API_OUTBOUND_DELIVERY_SRV_0002.PickingReport;
...
entity API_OUTBOUND_DELIVERY_SRV_0002.A_OutbDeliveryDocFlow {
  @sap.unicode : 'false'
...
entity API_OUTBOUND_DELIVERY_SRV_0002.A_MaintenanceItemObject {
  @sap.unicode : 'false'
...
entity API_OUTBOUND_DELIVERY_SRV_0002.A_SerialNmbrDelivery {
  @sap.unicode : 'false'
  @sap.label : 'Object list'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  ...
  @cds.ambiguous : 'missing on condition?'
  to_MaintenanceItemObject : Association to many API_OUTBOUND_DELIVERY_SRV_0002.A_MaintenanceItemObject on to_MaintenanceItemObject.MaintenanceItemObjectList = MaintenanceItemObjectList;
};
...
entity API_OUTBOUND_DELIVERY_SRV_0002.A_OutbDeliveryPartner {
  @sap.unicode : 'false'
  @sap.label : 'Partner Functn'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  ...
  @cds.ambiguous : 'missing on condition?'
  to_Address2 : Association to API_OUTBOUND_DELIVERY_SRV_0002.A_OutbDeliveryAddress2 on to_Address2.PartnerFunction = PartnerFunction and to_Address2.DeliveryDocument = SDDocument;
  @cds.ambiguous : 'missing on condition?'
  to_Address : Association to API_OUTBOUND_DELIVERY_SRV_0002.A_OutbDeliveryAddress {  };
};
...
entity API_OUTBOUND_DELIVERY_SRV_0002.A_OutbDeliveryAddress {
  @sap.unicode : 'false'
  @sap.label : 'Address Number'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
...
@cds.external : true
type API_OUTBOUND_DELIVERY_SRV_0002.HuReturn {
...
@cds.external : true
type API_OUTBOUND_DELIVERY_SRV_0002.CreatedDeliveryItem {
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  @sap.sortable : 'false'
  @sap.filterable : 'false'
...
@cds.external : true
type API_OUTBOUND_DELIVERY_SRV_0002.PickingReport {
  @sap.label : 'Message ID'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  @sap.sortable : 'false'
...
@cds.external : true
type API_OUTBOUND_DELIVERY_SRV_0002.Return {
  @sap.label : 'Group'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  @sap.sortable : 'false'
